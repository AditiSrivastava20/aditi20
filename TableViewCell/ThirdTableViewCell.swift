...
class ThirdTableViewCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        let nib = UINib(nibName: "fourthCollectionViewCell", bundle: nil)
        thirdCollectionView.register(nib, forCellWithReuseIdentifier: "CollectionCell4")
        // Initialization code
    ...
    {
        let Collectioncell4 = collectionView.dequeueReusableCell(withReuseIdentifier: "CollectionCell4", for : IndexPath) as! fourthCollectionViewCell
